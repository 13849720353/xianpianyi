...
<%--<div id="max">
    <div class="re">
        <ul>
            <li><div class="image-header"><img src="http://www.dujinming.cn/image/xh6jlbt1.png" class="img"></div></li>
            <li><div class="image-header"><img src="http://www.dujinming.cn/image/xh6jlbt2.png" class="img"></div></li>
            <li><div class="image-header"><img src="http://www.dujinming.cn/image/xh6jlbt3.png" class="img"></div></li>
            <li><div class="image-header"><img src="http://www.dujinming.cn/image/xh6jlbt4.png" class="img"></div></li>
            <li><div class="image-header"><img src="http://www.dujinming.cn/image/xh6jlbt5.png" class="img"></div></li>
        </ul>
    </div>
</div>--%>
