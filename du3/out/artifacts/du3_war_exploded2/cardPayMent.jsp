...
<head>
    ...
    <meta name="viewport" content="width=device-width,height=device-height,inital-scale=1.0,maximum-scale=1.0,ser-scalable=no;">
...
<nav class="navbar navbar-default navbar-fixed-bottom" style="backgroundcolor:#0000">
    <div class="navbar-header">
        <p class='navbar-brand' style="color:#FF0000">￥
            <input type=text id="price" value=${card.c_price} size="1" style= "background-color:transparent;border:0;">
        </p>
